...
Let us now check that the function $f: \mathbb{Z}_N \rightarrow \mathbb{Z}_{N^2}$, of the Paillier cipher where $f(m) = g^mr^N \mod N^2$ is a ring homomorphism, from $(\mathbb{Z}_N, +_N, \cdot_N)$ to $(\mathbb{Z}_{N^2}, +_{N^2}, \cdot_{N^2})$.
 - For all $a, b \in \mathbb{Z}_N$, $f(a +_N b) = f(a) +_{N^2} f(b)$, and 
 - for all $a, b \in \mathbb{Z}_N$, $f(a \cdot_N b) = f(a) \cdot_{N^2} f(b)$

For the Paillier configuration we have made, we define $p = 11$ and $q = 3$, in order to obtain $N = 33$ and thus $N^2 = 1089$. Thus, the plaintexts belong to the domain $\mathbb{Z}_{33}$ and the ciphertexts to the codomain $\mathbb{Z}_{1089}$. Suppose that the random integer values ​​chosen for g and r in the following instance are: $g = 5$ and $r = 7$. Let us check the homomorphism with arbitrary elements:

<div style="text-align: center;">
    <img src="assets/rings_homo.png" alt="rings_homo" width="400" height="240"/>
</div>

<div style="text-align: center;">
    <img src="assets/chiper_homo_1.png" alt="chiper_homo_1" width="400" height="240"/>
    <img src="assets/chiper_homo_2.png" alt="chiper_homo_2" width="400" height="240"/>
</div>
